...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/assets/exception.class.php');
    require_once(dirname(__FILE__).'/assets/locale.class.php');
    require_once(dirname(__FILE__).'/assets/myPdf.class.php');
    require_once(dirname(__FILE__).'/assets/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/assets/parsingCss.class.php');
    ...
    class HTML2PDF
    {
        ...
        public function __construct($orientation = 'P', $format = 'A4', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
        {
            ...
            $this->_setDefaultMargins(0,0, 0,0);
            $this->_setMargins();
            $this->_marges = array();
