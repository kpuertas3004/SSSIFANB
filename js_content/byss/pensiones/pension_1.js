...
//Dynamic Menu System
/*MNU[count(MNU)] = "Pensiones|Cambio de Situaci&oacute;n:f_cambioSituacion"
					+"#Calcula Pension Retiro:f_calculoPensionRetiro"
					+"#Calcula Pension:f_calculoPension"
					+"#Calculo de Retroactivo:f_calculoRetroactivo"
					+"#Cuentas Bancarias:f_cuentasBancarias"
					+"#Calcula Pension Especial:f_calculoPensionEspecial"
					+"#Defici&oacute;n y Ajuste de Beneficiarios:f_definicionAjusteBeneficiario"
					+"#Lista Beneficiario:f_listaBeneficiario"
					+"#Monto Beneficiario:f_montoBeneficiario"
					+"#Datos de Afiliacion:f_datosAfiliacion"
					+"#Medidas Judiciales"
					+"#Otras Operaciones de Pensi&oacute;n"
					+"#Reporte Pensi&oacute;n"
					+"#N&oacute;mina"
					+"#Juez Tipo:f_juezTipo"
					+"#Tipo Beneficiario:f_tipoBenficiarios"
					+"#Estatus Beneficiarios:f_estatusBenficiarios"
					+"#Razon Estatus Beneficiarios:f_razonEstatusBenficiarios"
					+"#Estatus Beneficiarios Montos:f_estatusBenficiariosMonto"
					+"#Concepto Monto:f_conceptoMonto"
					+"#Tipo Medida Judicial:f_tipoMedidaJudicial"
					+"#Medida Forma Calculo:f_medidaFormaCalculo"
					+"#Tipo Directiva:f_tipoDirectiva"
					+"#Directiva de Salario:f_directivaSalario"
					+"#Detalle de Directiva de Salario:f_detalleDirectivaSalario"
					+"#Copiar Directiva Salario:f_copiarDirectivaSalario"
					+"#Porcentaje Prestaciones:f_porcentajePrestaciones"
					+"#Detalle Porcentaje Prestaciones:f_detallePorcentajePrestaciones"
					+"#Vacaciones Rango:f_vacacionesRango"
					+"#Concepto Retroactivo:f_conceptoRetroactivo";
*/
...
/* */
	...
	html = html + html_colum5(10,25,20,5,25,"","Datos de Afiliacion",form_input_checkbox("bootstrap","chkDatosAfiliacion" ,"chkDatosAfiliacion" ,"",""),"","" )
	html = html + html_colum5(10,25,20,5,25,"","Historial Militar",form_input_checkbox("bootstrap","chkHistorialMilitar" ,"chkHistorialMilitar" ,"",""),"","" )
	html = html + html_colum5(10,25,20,5,25,"","Datos Militares",form_input_checkbox("bootstrap","chkDatosMilitares" ,"chkDatosMilitares" ,"",""),"","" )
	html = html + html_colum5(10,25,20,5,25,"","Cambio de Canal de Cobro de CXC",form_input_checkbox("bootstrap","chkCambioCanalCobroCXC" ,"chkCambioCanalCobroCXC" ,"",""),"","" )
